...
% \mt{What is the balance between comprehensive and redundant? I don't think I've found it... I'll try again when not exhausted} I'll let you know if I ever find it, but this looks pretty great - I've made a few tiny tweaks to phrasing, but the content is exactly what I was hoping for :)

\mt{Final paragraph will suggest redefining shapes (yuck) and cutting off the final conv block to see whether those features are easier for the model to sort between categories.} \svp{Sounds good!}
