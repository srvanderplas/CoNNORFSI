...
\author[mymainaddress]{Miranda Tilton}

\author[mymainaddress]{Susan Vanderplas\corref{mycorrespondingauthor}}
\cortext[mycorrespondingauthor]{Corresponding author}
\ead[url]{https://forensicstats.org}
\ead{srvander@iastate.edu}

\address[mymainaddress]{Statistics Department, Iowa State University}
