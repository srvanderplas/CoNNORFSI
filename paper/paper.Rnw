...
%\mt{Now that I can see the whole dang methods section, I think I prefer the order of the methods section as it is now, rather than the order suggested by the above comments, unless you disagree}
