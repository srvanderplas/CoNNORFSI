...
\item Confusion Matrix
  ...
  \end{itemize}
\item Two main reasons for error: some classes are more variable, and some classes share physical features (I.e., the model has to learn a lot of features to encapsulate a class with lots of variety, but then other classes share those features)
\item Brands
  \begin{itemize}
